...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        'flex flex-row gap-2 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 justify-end',
        className,
      )}
      {...props}
    />
...
function AlertDialogMedia({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-muted mb-2 inline-flex size-16 items-center justify-center rounded-md group-data-[size=default]/alert-dialog-content:row-span-2 *:[svg:not([class*='size-'])]:size-8",
        className,
      )}
      {...props}
    />
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        'text-lg font-medium group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2',
        className,
      )}
      {...props}
    />
